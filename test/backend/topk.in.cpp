...
NGRAPH_TEST(${BACKEND_NAME}, topk_1d_max_all)
{
    ...
    auto f0 = make_shared<Function>(B->output(0), ParameterVector{A});
    auto f1 = make_shared<Function>(B->output(1), ParameterVector{A});
...
NGRAPH_TEST(${BACKEND_NAME}, topk_3d_large_input_max)
{
    ...
    auto interp_f_0 = make_shared<Function>(B->output(0), ParameterVector{A});
    auto interp_f_1 = make_shared<Function>(B->output(1), ParameterVector{A});
