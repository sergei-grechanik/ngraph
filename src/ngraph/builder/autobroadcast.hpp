...
namespace ngraph
{
    namespace builder
    {
        ...
        std::pair<std::shared_ptr<Node>, std::shared_ptr<Node>>
            numpy_broadcast(const std::pair<Output, Output>& args);
        ...
        std::shared_ptr<NodeType> make_with_numpy_broadcast(const Output& operand1_reshapeable,
                                                            const Output& operand2_reshapeable)
        {
        ...
        /// \exception ngraph::builder::autobroadcast_incompatible_shapes
        template <typename NodeType>
        std::shared_ptr<Node> make_with_numpy_broadcast(const Output& operand1,
                                                        const Output& operand2_reshapeable,
                                                        const Output& operand3_reshapeable)
        {
