...
namespace
{
    ...
    std::shared_ptr<op::Slice> make_ng_slice(const Output& output,
...
NodeVector builder::split(const Output& value, const std::vector<size_t>& length_parts, size_t axis)
{
...
NodeVector builder::split(const Output& value, size_t split_parts, int axis)
{
