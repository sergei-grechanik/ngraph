...
namespace ngraph
{
    namespace builder
    {
        namespace detail
        {
            shared_ptr<Node> lp_norm(const Output& value,
                                     size_t p_norm,
        ...
        shared_ptr<Node> l0_norm(const Output& value, const AxisSet& reduction_axes)
        {
        ...
        shared_ptr<Node> l1_norm(const Output& value, const AxisSet& reduction_axes, float bias)
        {
        ...
        shared_ptr<Node> l2_norm(const Output& value,
                                 const AxisSet& reduction_axes,
                                 float bias,
                                 BiasMode bias_mode,
                                 bool keep_dims)
        ...
        shared_ptr<Node>
            lp_norm(const Output& value, const AxisSet& reduction_axes, size_t p_norm, float bias)
        {
