...
namespace ngraph
{
    namespace builder
    {
        ...
        protected:
            Output get_right() override;
            Output make_dot(const Output& left, const Output& right) override;
        };
