...
namespace ngraph
{
    namespace builder
    {
        ...
        ///
        std::shared_ptr<Node> l0_norm(const Output& value, const AxisSet& reduction_axes);
        ...
        ///
        std::shared_ptr<Node>
            l1_norm(const Output& value, const AxisSet& reduction_axes, float bias = 0.f);
        ...
        ///
        std::shared_ptr<Node> l2_norm(const Output& value,
        ...
        ///
        std::shared_ptr<Node> lp_norm(const Output& value,
                                      const AxisSet& reduction_axes,
                                      std::size_t p_norm = 2,
                                      float bias = 0.f);
    } // namespace builder
