...
namespace ngraph
{
    namespace builder
    {
        ...
        // clang-format on
        std::shared_ptr<Node> l2_norm(const Output& value, const AxisSet& reduction_axes);
        ...
        /// | \f$E[\textit{delete}(A,d_1,\dots,d_n)]\f$ | The tensor \f$T\f$, where \f$T\f$ is the input tensor with the `reduction_axes` \f$A\f$ eliminated by reduction. |
        // clang-format on
        std::shared_ptr<Node> mean(const Output& node, const AxisSet& reduction_axes);
        ...
        /// | \f$E[\textit{delete}(A,d_1,\dots,d_n)]\f$ | The tensor \f$T\f$, where \f$T\f$ is the input tensor with the `reduction_axes` \f$A\f$ eliminated by reduction. |
        // clang-format on
        std::shared_ptr<Node> std_dev(const Output& value,
