...
shared_ptr<Node> op::v1::Broadcast::copy_with_new_args(const OutputVector& new_args) const
{
...
shared_ptr<Node> op::v0::Broadcast::copy_with_new_args(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
...
shared_ptr<Node> op::v0::BroadcastLike::copy_with_new_args(const OutputVector& new_args) const
{
    if (new_args.size() != 2)
    {
