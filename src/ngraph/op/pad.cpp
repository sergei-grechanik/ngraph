...
shared_ptr<Node> op::v0::Pad::copy_with_new_args(const OutputVector& new_args) const
{
...
shared_ptr<Node> op::v1::Pad::copy_with_new_args(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
    const auto arg_pad_value_provided = get_input_size() == 4;
