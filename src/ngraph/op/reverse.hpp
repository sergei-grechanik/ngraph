    ...
    namespace op
    {
        namespace v0
        {
            ...
            public:
                ...
                Reverse(const Output& arg, const AxisSet& reversed_axes);
        ...
        namespace v1
        {
            ...
            public:
                ...
                Reverse(const Output& data, const Output& reversed_axes, const std::string& mode);

                Reverse(const Output& data, const Output& reversed_axes, const Mode mode);
