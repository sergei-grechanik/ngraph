    ...
    namespace op
    {
        namespace v1
        {
            ...
            public:
                ...
                ///
                Convolution(const Output& data_batch,
            ...
            public:
                ...
                // clang-format on
                ConvolutionBackpropData(const Output& data,
                                        const Output& filters,
            ...
            public:
                ...
                /// \param pads_begin The padding-below sizes from forward-prop.
                /// \param pads_end The padding-above sizes from forward-prop.
                ConvolutionBackpropFilters(const Output& data_batch,
        ...
        namespace v0
        {
            ...
            public:
                ...
                /// Output `[N, C_OUT, R1, ... Rf]`
                ///
                Convolution(const Output& data_batch, const Output& filters);
