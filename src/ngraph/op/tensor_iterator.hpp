    ...
    namespace op
    {
        namespace v0
        {
            ...
            public:
                ...
                /// from the
                /// last iteration.
                Output get_iter_value(const Output& body_value, int64_t iteration);
                ...
                /// \param end The last index on axis of the slicing
                /// \param axis The axis to slice along
                Output get_concatenated_slices(const Output& value,
                                               int64_t start,
                                               int64_t stride,
                                               int64_t part_size,
                                               int64_t end,
            ...
            private:
                ...
                Input input_for_value(const Output& value);
