...
shared_ptr<Node> op::Constant::copy_with_new_args(const OutputVector& new_args) const
{
...
std::shared_ptr<Node> op::ScalarConstantLike::copy_with_new_args(const OutputVector& new_args) const
{
