...
op::v0::Min::Min(const Output& arg, const AxisSet& reduction_axes)
    : ArithmeticReduction(arg, reduction_axes)
{
    constructor_validate_and_infer_types();
}

op::v0::Min::Min(const Output& arg, const Output& reduction_axes)
    : ArithmeticReduction(arg, reduction_axes)
{
    constructor_validate_and_infer_types();
}
...
op::v1::ReduceMin::ReduceMin(const Output& arg, const Output& reduction_axes, bool keep_dims)
