...
op::v0::MaxPool::MaxPool(const Output& arg,
...
op::v0::MaxPool::MaxPool(const Output& arg, const Shape& window_shape)
...
op::v0::MaxPoolBackprop::MaxPoolBackprop(const Output& arg_forward,
                                         const Output& delta,
                                         const Shape& window_shape,
                                         const Strides& window_movement_strides,
                                         const Shape& padding_below,
...
op::v1::MaxPool::MaxPool(const Output& arg,
...
op::v1::MaxPoolBackprop::MaxPoolBackprop(const Output& arg_forward,
                                         const Output& delta,
                                         const Strides& strides,
                                         const Shape& pads_begin,
                                         const Shape& pads_end,
