...
op::QuantizedConvolution::QuantizedConvolution(const Output& input,
                                               ...
                                               const Output& input_scale,
                                               const Output& input_zero_point,
                                               const Output& filter_scale,
                                               const Output& filter_zero_point,
