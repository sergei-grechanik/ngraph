...
op::v0::Subtract::Subtract(const Output& arg0,
                           const Output& arg1,
...
shared_ptr<ngraph::Node> ngraph::operator-(const Output arg0, const Output arg1)
{
...
op::v1::Subtract::Subtract(const Output& arg0,
                           const Output& arg1,
                           const AutoBroadcastSpec& auto_broadcast)
    : BinaryElementwiseArithmetic(arg0, arg1, auto_broadcast)
{
