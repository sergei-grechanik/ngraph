...
op::v0::Gather::Gather(const Output& params, const Output& indices, size_t axis)
    : Op({params, indices})
    , m_axis(axis)
{
...
op::v1::Gather::Gather(const Output& params, const Output& indices, const Output& axes)
