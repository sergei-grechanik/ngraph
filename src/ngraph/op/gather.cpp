...
shared_ptr<Node> op::v0::Gather::copy_with_new_args(const OutputVector& new_args) const
{
...
shared_ptr<Node> op::v1::Gather::copy_with_new_args(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
