    ...
    namespace op
    {
        namespace util
        {
            ...
            protected:
                ...
                ///
                static std::shared_ptr<Node> add(const Output& lhs, const Output& rhs);
                ///
                ...
                ///
                static std::shared_ptr<Node> sub(const Output& lhs, const Output& rhs);
                ///
                ...
                ///
                static std::shared_ptr<Node> mul(const Output& lhs, const Output& rhs);
                ///
                ...
                ///
                std::shared_ptr<Node> clip(const Output& data) const;
