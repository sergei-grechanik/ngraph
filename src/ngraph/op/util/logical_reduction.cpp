...
op::util::LogicalReduction::LogicalReduction(const Output& arg, const AxisSet& reduction_axes)
    : Op({arg,
          op::Constant::create(
...
op::util::LogicalReduction::LogicalReduction(const Output& arg, const Output& reduction_axes)
