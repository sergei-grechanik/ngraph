    ...
    namespace op
    {
        namespace v0
        {
            ...
            public:
                ...
                Max(const Output& arg, const AxisSet& reduction_axes);

                /// \brief Constructs a "max" reduction operation.
                ///
                /// \param arg The tensor to be reduced.
                /// \param reduction_axes The axis positions (0-based) to be elimaxated.
                Max(const Output& arg, const Output& reduction_axes);
        ...
        namespace v1
        {
            ...
            public:
                ...
                ReduceMax(const Output& arg, const Output& reduction_axes, bool keep_dims = false);
