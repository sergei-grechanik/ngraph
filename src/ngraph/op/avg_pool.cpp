...
op::v0::AvgPool::AvgPool(const Output& arg,
...
op::v0::AvgPool::AvgPool(const Output& arg, const Shape& window_shape)
...
op::v1::AvgPool::AvgPool(const Output& arg,
...
op::v1::AvgPoolBackprop::AvgPoolBackprop(const Output& delta,
                                         const Output& forward_arg_shape,
                                         const Strides& strides,
                                         const Shape& pads_begin,
                                         const Shape& pads_end,
                                         const Shape& kernel,
