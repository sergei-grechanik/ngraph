...
namespace ngraph
{
    namespace op
    {
        ...
        public:
            ...
            QuantizedConvolutionBias(const Output& data_batch,
            ...
            Output get_bias() { return input_value(2); }
        ...
        public:
            ...
            QuantizedConvolutionBiasAdd(const Output& data_batch,
                                        const Output& filters,
                                        const Output& bias,
        ...
        public:
            ...
            QuantizedConvolutionBiasSignedAdd(const Output& data_batch,
                                              const Output& filters,
                                              const Output& bias,
                                              const Output& sum_input,
                                              const Strides& window_movement_strides,
