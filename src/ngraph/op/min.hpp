    ...
    namespace op
    {
        namespace v0
        {
            ...
            public:
                ...
                Min(const Output& arg, const AxisSet& reduction_axes);

                /// \brief Constructs a "min" reduction operation.
                ///
                /// \param arg The tensor to be reduced.
                /// \param reduction_axes The axis positions (0-based) to be eliminated.
                Min(const Output& arg, const Output& reduction_axes);
        ...
        namespace v1
        {
            ...
            public:
                ...
                ReduceMin(const Output& arg, const Output& reduction_axes, bool keep_dims = false);
