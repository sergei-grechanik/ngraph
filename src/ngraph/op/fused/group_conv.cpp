...
shared_ptr<Node> op::v1::GroupConvolution::copy_with_new_args(const OutputVector& new_args) const
{
...
shared_ptr<Node>
    op::v1::GroupConvolutionBackpropData::copy_with_new_args(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
    if (new_args.size() == 3)
    {
...
shared_ptr<Node> op::v0::GroupConvolution::copy_with_new_args(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
...
shared_ptr<Node>
    op::v0::GroupConvolutionBackpropData::copy_with_new_args(const OutputVector& new_args) const
{
    if (new_args.size() != 3)
    {
...
shared_ptr<Node>
    op::v0::GroupConvolutionBackpropFilters::copy_with_new_args(const OutputVector& new_args) const
{
    if (new_args.size() != 3)
    {
        throw ngraph_error("Incorrect number of new arguments");
