...
shared_ptr<Node> op::CrossEntropy::copy_with_new_args(const OutputVector& new_args) const
{
...
shared_ptr<Node> op::CrossEntropyBackprop::copy_with_new_args(const OutputVector& new_args) const
{
    check_new_args_count(this, new_args);
