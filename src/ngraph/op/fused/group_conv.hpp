    ...
    namespace op
    {
        namespace v1
        {
            ...
            public:
                ...
                ///
                GroupConvolution(const Output& data_batch,
            ...
            public:
                ...
                // clang-format on
                GroupConvolutionBackpropData(const Output& data,
                                             const Output& filter,
        ...
        namespace v0
        {
            ...
            public:
                ...
                Output get_filters() { return input_value(1); }
                Output get_data_batch() { return input_value(0); }
            ...
            public:
                ...
                const NodeTypeInfo& get_type_info() const override { return type_info; }
                GroupConvolutionBackpropData() = default;
                GroupConvolutionBackpropData(const Output& data_batch,
                                             const Output& filters,
            ...
            public:
                ...
                GroupConvolutionBackpropFilters(const Output& data_batch,
                                                const Output& filters,
                                                const Output& output_delta,
                                                const Strides& window_movement_strides,
                                                const Strides& window_dilation_strides,
