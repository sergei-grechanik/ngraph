    ...
    namespace op
    {
        namespace v0
        {
            ...
            public:
                ...
                Split(const Output& data, const Output& axis, const size_t num_split);
                ...
                Split(const Output& data, const Output& axis, const std::vector<size_t>& splits);

                // TODO REMOVE THIS CONSTRUCTOR. INTRODUCED TO PROVIDE CI COMPATIBILITY
                Split(const Output& data, int axis, const std::vector<size_t>& splits);
        ...
        namespace v1
        {
            ...
            public:
                ...
                ///                    split into.
                Split(const Output& data, const Output& axis, const size_t num_splits);
