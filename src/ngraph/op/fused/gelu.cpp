...
shared_ptr<Node> op::Gelu::copy_with_new_args(const OutputVector& new_args) const
{
    if (new_args.size() != 1)
    {
...
shared_ptr<Node> op::GeluBackpropFactor::copy_with_new_args(const OutputVector& new_args) const
{
