...
op::v1::Convolution::Convolution(const Output& data_batch,
...
op::v1::ConvolutionBackpropData::ConvolutionBackpropData(const Output& data,
                                                         const Output& filters,
                                                         const Output& output_shape,
                                                         const Strides& strides,
                                                         const CoordinateDiff& pads_begin,
                                                         const CoordinateDiff& pads_end,
                                                         const Strides& dilations,
...
op::v1::ConvolutionBackpropFilters::ConvolutionBackpropFilters(const Output& data_batch,
                                                               const Output& output_delta,
                                                               const Output& filters_shape,
                                                               const Strides& strides,
                                                               const Strides& dilations,
                                                               const CoordinateDiff& pads_begin,
                                                               const CoordinateDiff& pads_end)
...
op::v0::Convolution::Convolution(const Output& data_batch,
                                 const Output& filters,
...
op::v0::Convolution::Convolution(const Output& data_batch, const Output& filters)
