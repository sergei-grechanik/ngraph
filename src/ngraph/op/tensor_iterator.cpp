...
Input op::TensorIterator::input_for_value(const Output& value)
{
...
Output op::TensorIterator::get_iter_value(const Output& body_value, int64_t iteration)
{
    ...
    return Output(shared_from_this(), output_index);
}

Output op::TensorIterator::get_concatenated_slices(const Output& body_value,
                                                   int64_t start,
                                                   int64_t stride,
                                                   int64_t part_size,
                                                   int64_t end,
