...
namespace ngraph
{
    namespace op
    {
        ...
        public:
            ...
            CPU_BACKEND_API SigmoidMultiply(const Output& input_0,
            ...
            static CPU_BACKEND_API FunctionType identify_node_type(const Output& node);
        ...
        public:
            ...
            SigmoidMultiplyBackprop(const Output& input_0,
                                    const Output& input_1,
                                    const Output& delta,
