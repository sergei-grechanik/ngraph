...
shared_ptr<Node> op::SigmoidMultiply::copy_with_new_args(const OutputVector& new_args) const
{
    if (new_args.size() != 2)
    {
...
shared_ptr<Node> op::SigmoidMultiplyBackprop::copy_with_new_args(const OutputVector& new_args) const
{
    if (new_args.size() != 3)
    {
