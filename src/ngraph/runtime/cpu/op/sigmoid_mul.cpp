...
ngraph::op::SigmoidMultiply::FunctionType
    op::SigmoidMultiply::identify_node_type(const Output& value)
{
...
op::SigmoidMultiply::SigmoidMultiply(const Output& input_0,
...
op::SigmoidMultiplyBackprop::SigmoidMultiplyBackprop(const Output& input_0,
                                                     const Output& input_1,
                                                     const Output& delta,
