...
namespace ngraph
{
    namespace op
    {
        ...
        public:
            ...
            GroupConvolutionBias(const Output& data_batch,
            ...
            Output get_bias() { return input(2).get_source_output(); }
            Output get_filters() { return input(1).get_source_output(); }
            Output get_data_batch() { return input(0).get_source_output(); }
